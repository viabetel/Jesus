...
export function PromotionsSection({ products }: { products: PublicProduct[] }) {
    ...
    <section className="bg-white py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-[1600px] px-6 sm:px-10">
        <div className="flex items-end justify-between mb-8 flex-wrap gap-6 sm:mb-10">
          <div>
            <p className="caps text-[10px] tracking-[0.22em] text-[var(--promo)] sm:text-[11px]">Por tempo limitado</p>
            <h2 className="mt-2 font-serif-italic text-[28px] leading-none sm:mt-3 sm:text-[36px] lg:text-[44px]">Promoções</h2>
          ...
          >
            Ver todas as ofertas <span className="transition-transform group-hover:translate-x-1"><ArrowRight size={13} /></span>
          </Link>
        </div>

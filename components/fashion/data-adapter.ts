...
export const MOCK_PRODUCTS: FashionProduct[] = [
  ...
  { id: "m4", slug: "camiseta-feminina-sal-e-luz", name: "Camiseta Feminina Sal e Luz", price: 79.90, parc: "3x de R$ 26,63", img: "/products/mock-feminino-sal-luz.jpg", badge: "Pronta Entrega", badgeKind: "olive", colors: ["#FFFFFF","#F5F1EC","#1A1A1A","#7B1E2B"], sizes: ["P","M","G"], stock: 12, isPromotion: false, description: "Camiseta cristã feminina com caimento confortável." },
  ...
  { id: "m8", slug: "camiseta-feminina-amor-maior", name: "Camiseta Feminina Amor Maior", price: 79.90, parc: "3x de R$ 26,63", img: "/products/mock-feminino-amor.jpg", badge: "Pronta Entrega", badgeKind: "olive", colors: ["#FFFFFF","#1A1A1A","#F5F1EC"], sizes: ["P","M","G"], stock: 7, isPromotion: false, description: "Camiseta feminina com mensagem de amor." },
]

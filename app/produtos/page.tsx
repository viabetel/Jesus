    ...
    <>
      ...
      <main className="min-h-dvh">
        <div className="mx-auto max-w-7xl px-4 py-8 lg:py-12">
          <div className="mb-8">
            <h1 className="font-serif text-3xl font-bold lg:text-4xl">Nossos Produtos</h1>
            <p className="mt-2 text-muted-foreground">Camisetas cristãs com estilo, qualidade e propósito</p>
          </div>
